...
import { fireEvent, render, renderer, screen } from '../../../testUtils'

import SearchFiltered, { FilterList } from '../SearchFiltered'
...
describe('SearchFiltered', () => {
  it('matches snapshot', () => {
    const component = renderer.create(<SearchFiltered withFilters />).toJSON()
